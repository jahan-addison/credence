...
constexpr std::ostream& operator<<(std::ostream& os, Directive d)
{
    switch (d) {
        ...
        X64_DIRECTIVE_OSTREAM(align);
        X64_DIRECTIVE_OSTREAM(p2align);
...
X64_DEFINE_1ARY_OPERAND_DIRECTIVE_FROM_TEMPLATE(p2align);
X64_DEFINE_1ARY_OPERAND_DIRECTIVE_FROM_TEMPLATE(align);
