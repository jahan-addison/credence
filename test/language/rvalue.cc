...
#include <credence/language/rvalue.h>   // for language::RValue_Parser
...
TEST_CASE("rvalue.cc: RValue_Parser::rvalue_expression")
{
    ...
    obj["test"] = credence::util::AST_Node::load(
        ...
        "[\"^\"]\n    "
        "            }]");
    auto temp = language::RValue_Parser(obj);
...
TEST_CASE("rvalue.cc: RValue_Parser::function_expression")
{
    ...
    auto function =
        get<credence::language::datatype::Datatype::Function>(test1.value);
    // parameters
    CHECK(get<credence::language::datatype::Datatype::LValue>(
...
TEST_CASE("rvalue.cc: RValue_Parser::evaluated_expression")
{
    ...
    auto expr1 =
        get<credence::language::datatype::Datatype::Pointer>(test1.value);
    CHECK(get<credence::language::datatype::Datatype::Relation>(
              get<credence::language::datatype::Datatype::Pointer>(expr1->value)
                  ->value)
              .first == Operator::B_MUL);
    auto test2 = temp.from_evaluated_expression_node(expressions.at(1));
    auto expr2 =
        get<credence::language::datatype::Datatype::Pointer>(test2.value);
    CHECK(get<credence::language::datatype::Datatype::LValue>(expr2->value)
              .first == "*x");
}
...
TEST_CASE("rvalue.cc: RValue_Parser::from_relation_expression")
{
    ...
    std::vector<credence::language::datatype::Datatype::Pointer> arguments{};
    temp.symbols_.table_.emplace("x", null);
    ...
    CHECK(
        std::get<credence::language::datatype::Datatype::Relation>(test1.value)
            .first == Operator::B_MUL);
    arguments =
        std::get<credence::language::datatype::Datatype::Relation>(test1.value)
            .second;
    CHECK(std::get<credence::language::datatype::Datatype::LValue>(
              arguments[0]->value)
              .first == "x");
    CHECK(std::get<int>(std::get<credence::language::datatype::Literal>(
              arguments[1]->value)
                  .first) == 10);
    ...
    CHECK(
        std::get<credence::language::datatype::Datatype::Relation>(test2.value)
            .first == Operator::R_LE);
    arguments = std::move(
        std::get<credence::language::datatype::Datatype::Relation>(test2.value)
            .second);
    CHECK(std::get<credence::language::datatype::Datatype::LValue>(
              ...
              .first == "x");
    CHECK(
        get<int>(get<credence::language::datatype::Literal>(arguments[1]->value)
                .first) == 5);
    CHECK(
        get<int>(get<credence::language::datatype::Literal>(arguments[2]->value)
                .first) == 10);
    CHECK(
        get<int>(get<credence::language::datatype::Literal>(arguments[3]->value)
                .first) == 1);

    auto test3 = temp.from_relation_expression_node(relation_expressions.at(2));
    CHECK(
        std::get<credence::language::datatype::Datatype::Relation>(test3.value)
    ...
    CHECK(
        std::get<credence::language::datatype::Datatype::Relation>(test4.value)
    ...
    CHECK(
        std::get<credence::language::datatype::Datatype::Relation>(test5.value)
            .first == Operator::XOR);
    arguments = std::move(
        std::get<credence::language::datatype::Datatype::Relation>(test5.value)
            .second);
    ...
    CHECK(
        std::get<credence::language::datatype::Datatype::Relation>(test6.value)
            .first == Operator::R_LT);
    arguments = std::move(
        std::get<credence::language::datatype::Datatype::Relation>(test6.value)
            .second);
    ...
    CHECK(
        std::get<credence::language::datatype::Datatype::Relation>(test7.value)
            .first == Operator::R_LE);
    arguments = std::move(
        std::get<credence::language::datatype::Datatype::Relation>(test7.value)
            .second);
...
TEST_CASE("rvalue.cc: RValue_Parser::from_unary_expression")
{
    ...
    std::shared_ptr<credence::language::datatype::Datatype> lvalue, constant;

    auto test1 = temp.from_unary_expression_node(unary_expressions.at(0));
    lvalue =
        std::get<credence::language::datatype::Datatype::Unary>(test1.value)
            .second;
    CHECK(std::get<credence::language::datatype::Datatype::Unary>(test1.value)
              .first == Operator::POST_INC);
    CHECK(
        std::get<credence::language::datatype::Datatype::LValue>(lvalue->value)
            .first == "x");

    auto test2 = temp.from_unary_expression_node(unary_expressions.at(1));
    lvalue =
        std::get<credence::language::datatype::Datatype::Unary>(test2.value)
            .second;
    CHECK(std::get<credence::language::datatype::Datatype::Unary>(test2.value)
    ...
    lvalue =
        std::get<credence::language::datatype::Datatype::Unary>(test3.value)
            .second;
    CHECK(std::get<credence::language::datatype::Datatype::Unary>(test3.value)
    ...
    constant =
        std::get<credence::language::datatype::Datatype::Unary>(test4.value)
            .second;
    CHECK(std::get<credence::language::datatype::Datatype::Unary>(test4.value)
              .first == Operator::U_ONES_COMPLEMENT);
    CHECK(std::get<int>(
              std::get<credence::language::datatype::Literal>(constant->value)
                  .first) == 5);

    auto test5 = temp.from_unary_expression_node(unary_expressions.at(4));
    lvalue =
        std::get<credence::language::datatype::Datatype::Unary>(test5.value)
            .second;
    CHECK(std::get<credence::language::datatype::Datatype::Unary>(test5.value)
    ...
    constant =
        std::get<credence::language::datatype::Datatype::Unary>(test6.value)
            .second;
    CHECK(std::get<credence::language::datatype::Datatype::Unary>(test6.value)
    ...
    lvalue =
        std::get<credence::language::datatype::Datatype::Unary>(test7.value)
            .second;
    CHECK(std::get<credence::language::datatype::Datatype::Unary>(test7.value)
    ...
    "rvalue.cc: RValue_Parser::from_assignment_expression")
{
    ...
    obj["test"] = credence::util::AST_Node::load(
        ...
        " "
        " }");
    auto temp = language::RValue_Parser(obj["symbols"]);
    ...
    credence::language::datatype::Literal assigned_type = { 5,
        language::datatype::TYPE_LITERAL.at("int") };
    ...
    auto lhs =
        std::get<credence::language::datatype::Datatype::Symbol>(expr.value)
            .first;
    auto* rhs =
        &std::get<credence::language::datatype::Datatype::Symbol>(expr.value)
             .second;
    ...
    CHECK(std::get<credence::language::datatype::Literal>((*rhs)->value) ==
          assigned_type);
}
...
TEST_CASE_FIXTURE(Fixture, "rvalue.cc: RValue_Parser::is_symbol")
{
    ...
    obj["test"] = credence::util::AST_Node::load("{\"node\":  \"lvalue\","
                                                 "\"root\": \"x\""
                                                 "}");
    auto temp = language::RValue_Parser(obj["test"]);
    // not declared with `auto' or `extern', should throw
    CHECK(temp.is_symbol(obj["test"]) == false);

    auto temp2 = language::RValue_Parser(obj["symbols"]);
...
TEST_CASE("rvalue.cc: RValue_Parser::from_vector_idenfitier")
{
    credence::util::AST_Node obj;
    obj["test"] = credence::util::AST_Node::load(
        "{\n                \"left\" : {\n                  \"node\" : "
...
TEST_CASE("rvalue.cc: RValue_Parser::from_integer_literal")
{
    credence::util::AST_Node obj;
    obj["test"] =
        credence::util::AST_Node::load("{\"node\":  \"integer_literal\","
...
TEST_CASE("rvalue.cc: RValue_Parser::from_float_literal")
{
    credence::util::AST_Node obj;
    obj["test"] =
...
TEST_CASE("rvalue.cc: RValue_Parser::from_double_literal")
{
    credence::util::AST_Node obj;
    obj["test"] =
