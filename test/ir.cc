...
TEST_CASE("ir/ir.cc: Intermediate_Representation::parse_node")
{
    using namespace ir;
    json::JSON obj;
...
TEST_CASE("ir/ir.cc: Intermediate_Representation::from_auto_statement")
{
    using namespace ir;
    json::JSON obj;
    obj["test"] = json::JSON::Load(
...
TEST_CASE("ir/ir.cc: Intermediate_Representation::from_assignment_expression")
{
    using namespace ir;
    json::JSON obj;
    obj["symbols"] = json::JSON::Load(
...
TEST_CASE("ir/ir.cc: Intermediate_Representation::on_identifier")
{
    using namespace ir;
    json::JSON obj;
    obj["symbols"] = json::JSON::Load(
    ...
    CHECK_THROWS(temp.on_identifier(obj["test"]));

    auto temp2 = Intermediate_Representation(obj["symbols"]);
    CHECK_THROWS(temp2.on_identifier(obj["test"]));

    temp2.symbols_.set_symbol_by_name("x", { "", "int", sizeof(int) });
    CHECK_NOTHROW(temp2.on_identifier(obj["test"]));
}
